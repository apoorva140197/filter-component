    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src/Introduction","files":"*.stories.tsx","importPathMatcher":"^\\.[\\\\/](?:src\\/Introduction\\/(?!\\.)(?=.)[^/]*?\\.stories\\.tsx)$"},{"titlePrefix":"","directory":"./src","files":"**/*.stories.tsx","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.tsx)$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:3000/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors~main.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>